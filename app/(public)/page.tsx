...
export default function HomePage() {
  return (
    <main className="min-h-svh overflow-hidden bg-[#071411] text-[#FFF8EC]">
      <section className="relative flex min-h-svh items-center justify-center overflow-hidden bg-[#071411] px-0 text-[#FFF8EC] sm:px-6">
        <Image
          src={heroImageSrc}
          ...
          priority
          sizes="100vw"
          className="scale-110 object-cover object-[center_58%] opacity-55 blur-2xl"
        />

        <div className="relative z-10 aspect-[2/3] h-svh max-h-[100svh] w-full max-w-[min(100vw,42rem)] overflow-hidden bg-[#071411] shadow-[0_28px_110px_rgba(5,13,11,0.45)] sm:rounded-[2rem]">
          <Image
            src={heroImageSrc}
            alt="Two people holding hands in a calm outdoor setting"
            fill
          ...
          <div className="relative z-10 flex h-full w-full flex-col items-center px-5 pb-9 pt-10 text-center sm:px-8 sm:pb-12 sm:pt-12">
            <div className="flex w-full flex-1 flex-col items-center justify-center gap-9 sm:gap-11">
              ...
              <section className="w-full max-w-[35rem] rounded-[2.25rem] border border-[#FFF8EC]/16 bg-[#071411]/68 px-6 pb-7 pt-8 shadow-[0_28px_90px_rgba(5,13,11,0.40)] backdrop-blur-md sm:rounded-[2.7rem] sm:px-10 sm:pb-9 sm:pt-10">
                <div className="mx-auto mb-7 flex h-14 w-20 items-center justify-center text-4xl text-[#F0A085]">
                  ♥♥
                </div>

                <h1 className="mx-auto max-w-xl font-serif text-[2.2rem] font-medium leading-[1.08] tracking-[-0.035em] text-[#FFF8EC] sm:text-[3.25rem]">
